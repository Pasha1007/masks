...
import { MaskEmitter } from "./MaskEmitter";
import { MaskState, InitFetchResult, SpinFetchResult } from "./type";
import { generateRandomString } from "./utils/generateRandomString";
import { postFetch } from "./utils/postFetch";
import { shuffleSlotKeys } from "./utils/shuffleSlotKeys";

export class MaskManager {
  public emitter = new MaskEmitter(this);
  ...
  constructor(ticket: string, main: Mask) {
    this.ticket = ticket;
    this.main = main;
  ...
  getValue<K extends keyof MaskState>(key: K) {
